...
def main():
    ...
    body = ('<div class="wrap"><a class="back" href="index.html">&larr; roster</a>'
            ...
            '<h1>Pick a face.</h1>'
            '<p class="sub">%d invented faces in three tiers, because how a face is lit and framed decides as much as the face does. <b>warm</b> is a line-up shot the way you photograph someone you like - real rooms, real light, a personality per face; <b>beauty</b> is a campaign key light; <b>casting</b> is the flat neutral card you judge a face on. None is a real person and none is a '
