...
def build(args):
    ...
    card = {
        ...
        # Comma-separated strings, matching every other card. The dossier joins these,
        # and a list crashed that read rather than failing loudly.
        "tags": ", ".join(tags_from(desc or args.desc or "")),
        "base_tags": ", ".join(tags_from(desc or args.desc or "")),
        "wear_tags": "",
