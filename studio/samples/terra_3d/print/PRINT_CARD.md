...
| | |
|---|---|
| Size | **80.8 x 54.5 x 150.0 mm** (w x d x h) MEASURED |
| Solid volume | **67.1 cm3** MEASURED |
| Surface area | 284 cm2 MEASURED |
| Triangles | 3,265,786 MEASURED |
...
| Material | ~74 g resin (~87 g with supports) ESTIMATE | ~38 g PLA, ~12.6 m of 1.75 mm ESTIMATE |
...
| | |
|---|---|
| Surface thinner than 0.80 mm | **0.21%** MEASURED |
| Surface thinner than 0.30 mm | **0.07%** MEASURED |
| Thinnest 1% of surface | 1.19 mm MEASURED |
| Median wall thickness | 7.8 mm MEASURED |
| Overhanging past 45 deg | **6.8%** of surface MEASURED |
| Of that, nothing beneath it | 13% - support from the plate MEASURED |
| Near-horizontal ceilings | 2.6% of surface MEASURED |
| Bed contact | 1969 mm2 MEASURED |

Where the remaining thin material is (share of all sub-0.80 mm surface):

- **torso and bodice** - holds 48% of it; 0.5% of that region's surface is thin
- **head and face** - holds 28% of it; 0.5% of that region's surface is thin
- **hips, wrap skirt, hair fall** - holds 11% of it; 0.2% of that region's surface is thin
- **hair crown and ribbon** - holds 5% of it; 0.2% of that region's surface is thin

Where the supports go (share of all overhanging surface):

- **torso and bodice** - 29% of it
- **head and face** - 19% of it
- **hips, wrap skirt, hair fall** - 18% of it
- **outstretched arms** - 15% of it

## Do you need to split it?

**No.** MEASURED reasoning, not a preference:

- It is 81 x 54 x 150 mm. That fits the build volume of every consumer
  FDM printer and every consumer MSLA machine except the smallest.
- Only **6.8%** of the surface overhangs past 45 deg, and only **13%** of
...
- The hardest case is the **outstretched arms**: they are near-horizontal
  cantilevers, and they carry the densest overhang of any band (14% of that
  band's own surface, against 11% for the torso). A waist or neck cut would
...
50.0 mm diameter, 6.0 mm thick, 1.5 mm chamfer on the top edge, flat
...
contact, against **1969 mm2** with the plinth. Her centre of mass also sits
**8.2 mm behind her feet** (the hair mass), which is 33% of the plinth
...
| | Before | After |
|---|---|---|
| Open (boundary) edges | 257 | **0** |
| Non-manifold edges | 30,476 | **0** |
| Disconnected shells | 4 | **1** |
...
|---|---|---|
| `TERRA_150mm.stl` | 163 MB | watertight, 3,265,786 faces, 80.85 x 54.45 x 150.00 mm |
| `TERRA_150mm.3mf` | 30 MB | watertight, 3,265,786 faces, 80.85 x 54.45 x 150.00 mm |
| `TERRA_150mm.glb` | 59 MB | watertight, 3,265,786 faces, 80.85 x 54.45 x 150.00 mm |
